export class felicidades1 extends Phaser.Scene{
    constructor(){
        super({key: 'felicidades1'});
    }
    preload(){
        this.load.image('fondo2','Imagenes/fondote.jpg');
        this.load.image('felicidades', 'Imagenes/Congratulation.png');
    ...
    create(){
        ...
        this.add.image(400, 100, 'felicidades');
